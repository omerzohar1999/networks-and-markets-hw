...
from hw3_uber import (
    exchange_network_from_uber,
    stable_outcome,
    random_riders_drivers_stable_outcomes,
)
...
assert set(Cset) == set(
    [1, 0, 2]
)  # This should be the only constricted set in this example
...
n, m, V = exchange_network_from_uber(
